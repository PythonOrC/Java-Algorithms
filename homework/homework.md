...
- [Assignment 4: Library](#assignment-4-library)
  ...
  - [Solution](#solution-3)
    - [`Book.java`](#bookjava-1)
    - [`Library.java`](#libraryjava-1)
...
[Download File](/homework/BookTemplate.java)
...
[Download File](/homework/LibraryTemplate.java)
...
```
[Downlaod Solution (Book.java)](Book.java)

[Downlaod Solution (Library.java)](Book.java)
